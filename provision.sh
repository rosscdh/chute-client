...
sudo cp $AS_USER_HOME/conf/chute-client.conf /etc/supervisor/conf.d/
sudo cp $AS_USER_HOME/conf/chute-client-worker.conf /etc/supervisor/conf.d/
sudo cp $AS_USER_HOME/conf/chute-client.ini /etc/uwsgi/apps-enabled/

sudo service redis-server restart
sudo service nginx restart
#sudo service supervisor restart
sudo supervisorctl restart chute-client
